...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="resources/css/food.css">
...
?>
    ...
    <div class="container-fluid product_page">
        ...
        <div class="row justify-content-center product_2_text">
            <p>We delivered in 20 minitues</p>
        </div>
    ...
    <div class="card-segment">
        <div class="container-fluid">
			...
			<?php
				$query = "SELECT * FROM food ORDER BY food_id ASC";
       ...
       <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                          ...
                          <form method="post" action="food.php?action=add&id=<?php echo $row["food_id"]; ?>">
